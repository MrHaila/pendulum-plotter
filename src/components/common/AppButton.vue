...
const variantClasses = computed(() => {
	...
	const map: Record<ButtonVariant, string> = {
		primary: `${motion} bg-gradient-to-b from-accent-primary-500 to-accent-primary-700 text-white shadow-[0_1px_3px_rgba(69,40,20,0.12)] hover:shadow-[0_4px_8px_rgba(69,40,20,0.18)] disabled:from-base-300 disabled:to-base-300 dark:disabled:from-base-700 dark:disabled:to-base-700 disabled:text-base-500`,

<template>
	<div class="space-y-3">
		...
		<div class="space-y-2">
			<!-- Theta -->
			<div>
				<div class="flex items-center justify-between text-xs font-mono font-light text-base-500 dark:text-base-400 mb-1">
					<span>θ</span>
...
const formattedPointCount = computed(() =>
	props.state.time === 0 ? '0' : props.pointCount.toLocaleString(),
)

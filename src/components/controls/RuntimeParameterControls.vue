<template>
	<div>
		...
		<div class="space-y-3">
			...
			<!-- Phi -->
			<div>
				<label class="block text-xs font-medium text-gray-700 mb-1"> φ (Polar): {{ state.phi.toFixed(3) }} rad </label>
			...
			<div class="pt-1">
				...
				<div class="text-sm font-mono text-gray-700">{{ pointCount.toLocaleString() }}</div>
			</div>
		</div>
	</div>
</template>

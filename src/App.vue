<template>
	...
	<div v-else class="flex h-full bg-base-50 dark:bg-base-900">
		<!-- Left Sidebar -->
		<aside
			class="w-80 flex-none border-r border-[#d7cbbf] dark:border-[rgba(255,210,160,0.06)] bg-base-100 dark:bg-base-800 p-3 space-y-0"
		>
			<div class="flex flex-col h-full">
				...
				<div class="pt-4 border-t border-[#d7cbbf] dark:border-[rgba(255,210,160,0.06)]">
